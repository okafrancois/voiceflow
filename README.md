<div align="center">
  <img src="./assets/logo.png" alt="Voice Flow logo" width="96"/>
  ...
  <p>
    <a href="https://github.com/okafrancois/voiceflow/releases">Download</a>
    ·
    <a href="https://github.com/okafrancois/voiceflow">Website</a>
    ·
    <a href="context/README.md">Docs</a>
    ·
    <a href="https://github.com/okafrancois/voiceflow/discussions">Discussions</a>
  </p>
  ...
  <img src="./packages/website/public/illustration/showcase.png" alt="Voice Flow Showcase" width="100%"/>
</div>
...
Voice Flow starts with the writing you do all day: replies, notes, prompts, rough ideas, and text that needs to land in the app you are already using.
...
Voice Flow is built for your desktop, not just a single input box.
...
Voice Flow is a voice layer for the desktop, not another place you have to move your work into.
...
Voice Flow asks for only the permissions needed to make desktop voice interaction work:
...
Voice Flow does not require an account and does not upload your voice by default. Remote services are optional and are used only when you configure and enable them.
...
- [GitHub Releases](https://github.com/okafrancois/voiceflow/releases)
- [Official website](https://github.com/okafrancois/voiceflow)

After installation, follow the system prompts to grant microphone and accessibility permissions.

## Project Status

Voice Flow is under active development. The macOS version is usable today, and the Windows version is in progress.
...
Voice Flow is licensed under [AGPL-3.0](LICENSE).
